...
class basicUrl():
	...
	def getdatDate(self):
		...
		data=time_date+spl+str(float(self._totusetime.seconds)+0.000001*float(self._totusetime.microseconds))+spl+str(float(self._basictime.seconds)+0.000001*float(self._basictime.microseconds))+spl+return_errcode+"\n"
		return data
